...
const cardDeleteButtonClassName = (
  `place__button-delete ${isOwn ? 'place__button-delete_visible' : ""}`);
...
const cardLikeButtonClassName = (
  ...
  return (
    <li className="place" key={props.card._id}>
      ...
      />
      <button className={cardDeleteButtonClassName} onClick={() => handleDeleteClick(props.card)}>
      ...
      <div className="place__data">
        ...
        <div className="place__like">
          <button className="place__button-like">
            <img src={cardLikeButtonClassName} alt="botão para curtir postagem" onClick={() => handleLikeClick(props.card)}  />
          </button>
